...
interface FailureByMunicipioChartProps {
    data: FailureData[];
}

const FailureByMunicipioChart: React.FC<FailureByMunicipioChartProps> = ({ data }) => {
        ...
        <div style={{ width: '100%', height: 400 }}>
            <ResponsiveContainer>
                <BarChart data={data} margin={{ top: 20, right: 20, left: 0, bottom: 5 }}>
                    ...
                    <Bar dataKey="porcentaje" name="% de Fallas" fill="#f472b6" isAnimationActive={false}>
                        <LabelList 
                            dataKey="porcentaje" 
                            position="top" 
